...
<html lang="en">
<head>
	<title>Gracehouse ~Galleria</title>
					...
					<div class="grid_12">
						...
						<nav id="main-nav" class="nav-collapse">
							<ul id="main-menu" class="md-menu">
								...
								<li><a class="pg-active" href="../gallery/"><i class="fa fa-camera"></i> Gallery</a></li>
	        ...
	        <div class="md-body-wrapper">
				<section class="container">
					<div class="md-body md-accomodation">
						<h1 class="h3-beverly">Gracehouse Gallery</h1>
						...
						<section class="md-accomodation-content">
							<div class="row clearfix">
								<div class="grid_4">
									<article class="media">
										<figure>
											<a href="../../img/gallery/big/1.jpg" data-lightbox="example-set">
												<img src="../../img/gallery/1.jpg" alt="" class="media-object">
											</a>
										</figure>
									</article>
								</div>
								<div class="grid_4">
									<article class="media">
										<figure>
											<a href="../../img/gallery/big/2.jpg" data-lightbox="example-set">
												<img src="../../img/gallery/2.jpg" alt="" class="media-object">
											</a>
										</figure>
									</article>
								</div>
								<div class="grid_4">
									<article class="media">
										<figure>
											<a href="../../img/gallery/big/3.jpg" data-lightbox="example-set">
												<img src="../../img/gallery/3.jpg" alt="" class="media-object">
											</a>
										</figure>
									</article>
								</div>
							...
							<div class="row clearfix">
								<div class="grid_4">
									<article class="media">
										<figure>
											<a href="../../img/gallery/big/4.jpg" data-lightbox="example-set">
												<img src="../../img/gallery/4.jpg" alt="" class="media-object">
											</a>
										</figure>
									</article>
								</div>
								<div class="grid_4">
									<article class="media">
										<figure>
											<a href="../../img/gallery/big/5.jpg" data-lightbox="example-set">
												<img src="../../img/gallery/5.jpg" alt="" class="media-object">
											</a>
										</figure>
									</article>
								</div>
								<div class="grid_4">
									<article class="media">
										<figure>
											<a href="../../img/gallery/big/6.jpg" data-lightbox="example-set">
												<img src="../../img/gallery/6.jpg" alt="" class="media-object">
											</a>
										</figure>
									</article>
								</div>
